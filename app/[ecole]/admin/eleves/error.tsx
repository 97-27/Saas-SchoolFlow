...
import { RotateCcw, AlertTriangle, Users, Home } from 'lucide-react';
import Link from 'next/link';
import { useParams } from 'next/navigation';

export default function ElevesError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Vue d\'ensemble Élèves Error Boundary:', error);
  }, [error]);
      ...
      <div className="max-w-md w-full bg-white rounded-3xl border-2 border-slate-200 shadow-xl p-6 sm:p-8 text-center space-y-4">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1.5 leading-relaxed">
            Une interruption temporaire est survenue lors de l&apos;actualisation du registre scolaire. Vos données et élèves enregistrés sont scrupuleusement préservés.
          </p>
        </div>
